...
class Navigation_Screen extends StatelessWidget {
  ...
  CollectionReference allgames =
      FirebaseFirestore.instance.collection('AllGames');
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        //         FirebaseFirestore.instance.collection("AllGames");
        //
        //     for (Map<String, dynamic> product in AllGame) {
        ...
        body: StreamBuilder<QuerySnapshot>(
          ...
          builder:
            ...
            snapshot.data!.docs.forEach((element) {
              kkkk.add(element.data() as Map<String, dynamic>);
            });
            print('kkkkkkk-----${kkkk}');
            return GetBuilder<InternetChake>(
